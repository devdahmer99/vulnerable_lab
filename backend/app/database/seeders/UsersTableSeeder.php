...
class UsersTableSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('users')->insert([
            ['name'=>'Alice Admin','email'=>'alice@example.com','password'=>'admin123','role'=>'admin'],
            ['name'=>'Bob User','email'=>'bob@example.com','password'=>'password','role'=>'user'],
            ['name'=>'Carol User','email'=>'carol@example.com','password'=>'123456','role'=>'user']
        ]);
